...
public class  YSIActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ysiactivity);

        //buka webnya
        webView = findViewById(R.id.ysi_webview);
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://yuk-simak.info/tentang-yuk-simak-info/");
